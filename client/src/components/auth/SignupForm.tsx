    ...
    <form onSubmit={handleSubmit} autoComplete="off" className="flex flex-col gap-2 w-full animate-in fade-in slide-in-from-right duration-500">
      ...
      <div className="flex flex-col gap-2 mt-2">
        ...
        <button
          ...
          className="w-full py-2.5 px-6 rounded-xl bg-white border-2 border-slate-100 text-[#001533] font-bold text-sm transition-all hover:bg-slate-50 hover:border-slate-200 active:scale-[0.98] flex items-center justify-center gap-3 shadow-sm"
        >
