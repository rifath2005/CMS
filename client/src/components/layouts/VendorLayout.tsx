                ...
                <div className="h-20 flex items-center px-8 mb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-xl font-black tracking-tight text-[#1E293B]">
                             <span className="text-black-500">Notin</span><span className="text-[#ff7a00]">Q</span> <span className="text-[#1E293B]">Vendor</span>
                        </h1>
                    </div>
                </div>
                ...
                <div className="p-4 border-t border-gray-100 bg-gray-50/30 m-2 rounded-2xl">
                    <div className="flex items-center gap-3 mb-3 px-1">
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-xs font-bold text-[#1E293B] truncate">{user?.name || 'Vendor'}</p>
            ...
            <div className="flex-1 flex flex-col min-h-screen overflow-hidden">
                ...
                <header className="h-8 bg-white border-b border-gray-100 flex items-center justify-between px-8 sticky top-0 z-10">
                    ...
                    <div className="hidden md:block">
                         <p className="text-xl font-semibold text-gray-400">Panel Context: <span className="text-[#1E293B] font-black uppercase tracking-tight">Vendor Panel</span></p>
                    </div>
