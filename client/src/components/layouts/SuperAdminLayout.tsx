                ...
                <div className="h-20 flex items-center px-8 mb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-xl font-black tracking-tight text-[#1E293B]">
                             <span className="text-purple-700">CMS</span> <span className="text-[#1E293B]">Platform</span>
                        </h1>
                    </div>
                </div>
                ...
                <div className="p-6 border-t border-gray-100 bg-gray-50/30 m-4 rounded-3xl">
                    <div className="flex items-center gap-3 mb-4 px-2">
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-sm font-bold text-[#1E293B] truncate">{user?.name || 'Super Admin'}</p>
            ...
            <div className="flex-1 flex flex-col min-h-screen overflow-hidden">
                ...
                <header className="h-20 bg-white border-b border-gray-100 flex items-center justify-between px-8 sticky top-0 z-10">
                    <div className="md:hidden flex items-center gap-3">
                         <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-purple-600 to-indigo-600 flex items-center justify-center text-white text-xs font-bold shadow-md">S</div>
                         <span className="font-bold text-[#1E293B]">CMS Platform</span>
                    </div>

                    <div className="hidden md:block">
                         <p className="text-sm font-semibold text-gray-400">Governance: <span className="text-purple-600 font-black uppercase tracking-tight">Super Admin Portal</span></p>
                    </div>
