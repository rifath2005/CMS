...
const Cart = () => {
    ...
    return (
        <div className="px-2 sm:px-4 lg:px-6 py-2 sm:py-3 lg:py-4">
            ...
            {/* Order Summary */}
            <div className="bg-white rounded-lg shadow-sm p-4 sm:p-5 lg:p-6 hover:shadow-md">
                ...
                <div className="space-y-2.5 sm:space-y-3">
                    <button
                        ...
                        className="w-full bg-primary-600 text-white py-2 sm:py-2.5 pr-2 text-sm sm:text-base rounded-lg hover:bg-primary-700 font-medium flex items-center justify-center hover:shadow-md"
                    >
                        Proceed to Checkout
                    ...
                    <button
                        onClick={() => navigate('/products')}
                        className="w-full border-2 border-gray-300 text-gray-700 py-2 sm:py-2.5 text-sm sm:text-base rounded-lg hover:bg-gray-50 font-medium hover:shadow-sm"
                    >
                        Continue Shopping
                    </button>
                </div>
